...
if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) 
		...
		var cmap_poverty = [{"label" : ">&nbsp;87.0", "lower" : 87.0, "fill" : '#08589e'},
						{"label" : "75.0&nbsp;-&nbsp;87.0", "lower" : 75.0, "fill" : '#2b8cbe'},
						{"label" : "62.0&nbsp;-&nbsp;75.0", "lower" : 62.0, "fill" : '#4eb3d3'},
						{"label" : "50.0&nbsp;-&nbsp;62.0", "lower" : 50.0, "fill" : '#7bccc4'},
						{"label" : "37.0&nbsp;-&nbsp;50.0", "lower" : 37.0, "fill" : '#a8ddb5'},
						{"label" : "25.0&nbsp;-&nbsp;37.0", "lower" : 25.0, "fill" : '#ccebc5'},
						{"label" : "12.0&nbsp;-&nbsp;25.0", "lower" : 12.0, "fill" : '#e0f3db'},
						{"label" : "<&nbsp;12.0", "lower" : 0.0,  "fill" : '#f7fcf0'}];
